...
class SoftmaxModel(Model):
    ...
    def add_prediction_op(self):
        ...
        """
        ### YOUR CODE HERE
        W =  tf.Variable(tf.to_float(tf.zeros((self.config.n_features,self.config.n_classes))))
        b = tf.Variable(tf.to_float(tf.zeros(self.config.n_classes,)))
    ...
    def add_loss_op(self, pred):
        ...
        #loss = tf.reduce_sum(entropy_matrix)
