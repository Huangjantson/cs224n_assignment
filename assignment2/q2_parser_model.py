...
class ParserModel(Model):
    ...
    def add_embedding(self):
        ...
        lookup_result = tf.nn.embedding_lookup(self.pretrained_embeddings,self.input_placeholder)
    ...
    def add_loss_op(self, pred):
        ...
        """
        ### YOUR CODE HERE
        entropy_matrix = tf.nn.softmax_cross_entropy_with_logits(labels = self.labels_placeholder,logits = pred)
